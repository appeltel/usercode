...
void plotTrackingPerformanceHi() {
  ...
  TFile *f = new TFile("./trackCorrections_CMSSWSchool.root");

  // sim-to-reco hists
  TH2F *hSim = (TH2F*) f->Get("trkCorr_HIN12017/hsim"); hSim->GetYaxis()->SetRangeUser(0.2,100);
  TH2F *hEff = (TH2F*) f->Get("trkCorr_HIN12017/heff"); hEff->GetYaxis()->SetRangeUser(0.2,100);
  TH2F *hMul = (TH2F*) f->Get("trkCorr_HIN12017/hmul"); hMul->GetYaxis()->SetRangeUser(0.2,100);

  // reco-to-sim hists
  TH2F *hRec = (TH2F*) f->Get("trkCorr_HIN12017/hrec"); hRec->GetYaxis()->SetRangeUser(0.2,100);
  TH2F *hFak = (TH2F*) f->Get("trkCorr_HIN12017/hfak"); hFak->GetYaxis()->SetRangeUser(0.2,100);
  TH2F *hSec = (TH2F*) f->Get("trkCorr_HIN12017/hsec"); hSec->GetYaxis()->SetRangeUser(0.2,100);
  ...
  rFak->SetStats(0);
  rFak->SetMaximum(0.05); rFak->SetMinimum(0.0);
  ...
  TH1D* hDumEta3 = (TH1D*) hDumEta->Clone("hDumEta3"); hDumEta3->SetMaximum(0.02); 
  ...
  TH1D* hDumPt = new TH1D("hDumPt",";p_{T} [GeV/c]",80,0.2,100.0); hDumPt->SetMaximum(1.0);
  ...
  TH1D* hDumPt3 = (TH1D*) hDumPt->Clone("hDumPt3"); hDumPt3->SetMaximum(0.02); 
  ...
  gMulEta->BayesDivide(hMulEta,hRecEta);
  ...
  gMulPt->BayesDivide(hMulPt,hRecPt);
  ...
  gMulEta2->BayesDivide(hMulEta2,hRecEta2);
  ...
  gMulPt2->BayesDivide(hMulPt2,hRecPt2);
